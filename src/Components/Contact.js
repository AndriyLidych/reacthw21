                    ...
                    this.filter().map((el) =>
                        <div className='contact__wrapper-card'>
                            <p className='card__wrapper'>
                                {el.gender == 'male' ? <img className='card__icon' src='http://simpleicon.com/wp-content/uploads/business-man-3.png' /> :
                                    el.gender == 'female' ? <img className='card__icon' src='https://icon-library.com/images/woman-icon-png/woman-icon-png-10.jpg' /> :
                                        el.firstName[0]}
                            </p>
